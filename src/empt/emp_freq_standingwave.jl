...
function run_freq(ω, η₀, α)
  ...
  a((ϕ,κ),(w,u)) =      
    ...
    #  + ∫(  βₕ*(u + αₕ*w)*(g*κ - im*ω*ϕ) + im*ω*w*κ 
    #   - μ₂ₒᵤₜ*κ*w + μ₁ₒᵤₜ*∇ₙ(ϕ)*(u + αₕ*w) 
    #   )dΓd2             # Damping zone 2 not used，wall instead
...
name::String = "data/sims_202506/sims_standing_wave"
order::Int = 2
vtk_output::Bool = true
filename = name*"/mem"

H0 = 5 #m #still-water depth
...
LΩ = 2*Ld +3*H0 #modify this to change the domain length
x₀ = -Ld
